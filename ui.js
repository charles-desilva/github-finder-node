class UI{
    ...
    clearProfile(){
        this.profile.innerHTML ='<div class="card card-body mb-3 bg-light">Please type Name above to display Git Profile Details</div>';
    }

    showAlert(msg, style){
        this.profile.innerHTML =`<div class="card card-body mb-3 ${style}">${msg}</div>`;
    }
           ...
           repos.forEach(function(repo){
               ...
               <div class="card card-body mb-2">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span class="badge badge-primary mb-1">Starts: ${repo.stargazers_count}</span>
